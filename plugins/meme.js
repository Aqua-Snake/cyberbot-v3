...
if (Config.WORKTYPE == 'private') {
    ...
    CBot.addCommand({pattern: 'meme ', fromMe: true, desc: Lang.MEMES_DESC}, (async (message, match) => {   
	    ...
	    memeMaker({
            ...
            await message.client.sendMessage(message.jid, fs.readFileSync('CyberBot-meme.png'), MessageType.image, {filename: 'CyberBot-meme.png', mimetype: Mimetype.png, caption: Config.ALLCAP});
            await info.delete();    
        });
    }));
}
    ...
    CBot.addCommand({pattern: 'meme ', fromMe: false, desc: Lang.MEMES_DESC}, (async (message, match) => {    
	 ...
	 if (match[1].includes('{1}')) {    
	    ...
	    fontSize: 150, 	
            ...
            if(err) throw new Error(err)
            await message.client.sendMessage(message.jid, fs.readFileSync('plk-cyberbot.png'), MessageType.image, {filename: 'cyberbot_meme.png', mimetype: Mimetype.png, caption: Config.ALLCAP});
            await info.delete();    
        });
       }
