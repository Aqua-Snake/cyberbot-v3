...
if (Config.WORKTYPE == 'private') {
    ...
    CBot.addCommand({pattern: 'ss ', fromMe: true, desc: Lang.SS_DESC}, (async (message, match) => {
    ...
    CBot.addCommand({pattern: 'ss ', fromMe: false, desc: Lang.SS_DESC}, (async (message, match) => {
