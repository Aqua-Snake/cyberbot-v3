...
if (Config.WORKTYPE == 'private') {
    ...
    CBot.addCommand({pattern: 'meme ', fromMe: true, desc: Lang.MEMES_DESC}, (async (message, match) => {   
	    ...
	    memeMaker({
            ...
            await message.client.sendMessage(message.jid, fs.readFileSync('cbot-meme.png'), MessageType.image, {filename: 'cbot-meme.png', mimetype: Mimetype.png, caption: Config.ALLCAP});
            await info.delete();    
        });
    }));
}
