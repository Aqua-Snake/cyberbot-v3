...
CBot.addCommand({pattern: 'txtit$', fromMe: wk, desc: desc_msg}, (async (message, match) => {
    var t1 = ''
    var t2 = ''
    var t3 = ''
    var t4 = ''
...
CBot.addCommand({pattern: 'devil ', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/devil.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/devil.jpg'), MessageType.image, { caption: Config.ALLCAP })
              })
          } catch(err) { 
              console.log(err)
          } 
...
CBot.addCommand({pattern: 'bear ', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/bear.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/bear.jpg'), MessageType.image, { caption: Config.ALLCAP })
              })
          } catch(err) { 
              console.log(err)
          } 
...
CBot.addCommand({pattern: 'wolf ', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/wolf.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/wolf.jpg'), MessageType.image, { caption: Config.ALLCAP })
              })
          } catch(err) { 
              console.log(err)
          } 
...
CBot.addCommand({pattern: 'neon ', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/neon.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/neon.jpg'), MessageType.image, { caption: Config.ALLCAP })
              })
          } catch(err) { 
              console.log(err)
          } 
...
CBot.addCommand({pattern: '2neon ', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/neon2.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/neon2.jpg'), MessageType.image, { caption: Config.ALLCAP })
              })
          } catch(err) { 
              console.log(err)
          } 
...
CBot.addCommand({pattern: 'light ', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/li.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/li.jpg'), MessageType.image, { caption: Config.ALLCAP })
              })
          } catch(err) { 
              console.log(err)
          } 
...
CBot.addCommand({pattern: 'joker ', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/joker.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/joker.jpg'), MessageType.image, { caption: Config.ALLCAP })
              })
          } catch(err) { 
              console.log(err)
          } 
...
CBot.addCommand({pattern: 'ninja ', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/ninja.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/ninja.jpg'), MessageType.image, { caption: Config.ALLCAP })
              })
          } catch(err) { 
              console.log(err)
          } 
...
CBot.addCommand({pattern: 'glitter ', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/tt.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/tt.jpg'), MessageType.image, { caption: Config.ALLCAP })
              })
          } catch(err) { 
              console.log(err)
          } 
...
CBot.addCommand({pattern: 'bokeh ', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/bkh.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/bkh.jpg'), MessageType.image, { caption: Config.ALLCAP })
              })
          } catch(err) { 
              console.log(err)
          } 
...
CBot.addCommand({pattern: 'marvel ', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/marvel.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/marvel.jpg'), MessageType.image, { caption: Config.ALLCAP })
              })
          } catch(err) { 
              console.log(err)
          } 
...
CBot.addCommand({pattern: '2marvel ', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/mar2.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/mar2.jpg'), MessageType.image, { caption: Config.ALLCAP })
              })
          } catch(err) { 
              console.log(err)
          } 
...
CBot.addCommand({pattern: 'avengers ', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/aven.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/aven.jpg'), MessageType.image, { caption: Config.ALLCAP })
              })
          } catch(err) { 
              console.log(err)
          } 
...
CBot.addCommand({pattern: 'glitch ', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/tt2.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/tt2.jpg'), MessageType.image, { caption: Config.ALLCAP })
              })
          } catch(err) { 
              console.log(err)
          } 
...
CBot.addCommand({pattern: 'graf ', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/ttgra.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/ttgra.jpg'), MessageType.image, { caption: Config.ALLCAP })
              })
          } catch(err) { 
              console.log(err)
          } 
...
CBot.addCommand({pattern: '2graf ', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/t2gra.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/t2gra.jpg'), MessageType.image, { caption: Config.ALLCAP })
              })
          } catch(err) { 
              console.log(err)
          } 
...
CBot.addCommand({pattern: 'lion ', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/lion.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/lion.jpg'), MessageType.image, { caption: Config.ALLCAP })
              })
          } catch(err) { 
              console.log(err)
          } 
...
CBot.addCommand({pattern: '3neon ', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/neon3.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/neon3.jpg'), MessageType.image, { caption: Config.ALLCAP })
              })
          } catch(err) { 
              console.log(err)
          } 
...
CBot.addCommand({pattern: 'ice ', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/ice.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/ice.jpg'), MessageType.image, { caption: Config.ALLCAP })
              })
          } catch(err) { 
              console.log(err)
          } 
...
CBot.addCommand({pattern: 'space ', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/space.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/space.jpg'), MessageType.image, { caption: Config.ALLCAP })
              })
          } catch(err) { 
              console.log(err)
          } 
...
CBot.addCommand({pattern: 'smoke ', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/smoke.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/smoke.jpg'), MessageType.image, { caption: Config.ALLCAP })
              })
          } catch(err) { 
              console.log(err)
          } 
...
CBot.addCommand({pattern: 'glow ', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var download = async(uri, filename, callback) => {
        await request.head(uri, async(err, res, body) => {    
            await request(uri).pipe(fs.createWriteStream(filename)).on('close', callback);
        });
    ...
    await download(`https://api.xteam.xyz/photooxy/neonlight?text=${uri}&APIKEY=da5fb2b73ae3e451`, '/root/WhatsAsenaDuplicated/glowttp.jpg', async() => {                          
        await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/glowttp.jpg'), MessageType.image, { caption: Config.ALLCAP })
    })
}));
CBot.addCommand({pattern: 'fire ', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/tfire.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/tfire.jpg'), MessageType.image, { caption: Config.ALLCAP })
              })
          } catch(err) { 
              console.log(err)
          } 
...
CBot.addCommand({pattern: 'harry ', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/hp.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/hp.jpg'), MessageType.image, { caption: Config.ALLCAP })
              })
          } catch(err) { 
              console.log(err)
          } 
...
CBot.addCommand({pattern: '4neon ', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/t4n.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/t4n.jpg'), MessageType.image, { caption: Config.ALLCAP })
              })
          } catch(err) { 
              console.log(err)
          } 
...
CBot.addCommand({pattern: 'cemetery ', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/cmth.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/cmth.jpg'), MessageType.image, { caption: Config.ALLCAP })
              })
          } catch(err) { 
              console.log(err)
          } 
...
CBot.addCommand({pattern: 'cup ', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/cup.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/cup.jpg'), MessageType.image, { caption: Config.ALLCAP })
              })
          } catch(err) { 
              console.log(err)
          } 
