...
let whb = Config.WORKTYPE == 'public' ? false : true
	...
	CBot.addCommand({pattern: 'infobot', fromMe: whb, desc: 'Infomation about CyberBot'}, (async (message, match) => {
	...
	CBot.addCommand({pattern: 'infodev', fromMe: whb, desc: 'Developer Infomation'}, (async (message, match) => {
	...
	CBot.addCommand({pattern: 'infoca', fromMe: whb, desc: 'Cyber Army Infomation'}, (async (message, match) => {
