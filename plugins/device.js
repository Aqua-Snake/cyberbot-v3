...
CBot.addCommand({pattern: 'device ', fromMe: true, desc: Lang.DEVICE , dontAddCommandList: true }, async (message, match) => {
...
msg += '```'
 return await message.client.sendMessage(message.jid, msg, MessageType.text, { quoted: message.data });
    ...
    CBot.addCommand({pattern: 'device ', fromMe: false, desc: Lang.DEVICE , dontAddCommandList: true }, async (message, match) => {
